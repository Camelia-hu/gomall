...
type Client interface {
	CreateCredit(ctx context.Context, Req *payment.CreateCreditReq, callOptions ...callopt.Option) (r *payment.CreateCreditResp, err error)
...
func (p *kPaymentServiceClient) CreateCredit(ctx context.Context, Req *payment.CreateCreditReq, callOptions ...callopt.Option) (r *payment.CreateCreditResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.CreateCredit(ctx, Req)
}
