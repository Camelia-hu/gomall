...
var CreateProductArgs_Req_DEFAULT *product.CreateReq

func (p *CreateProductArgs) GetReq() *product.CreateReq {
	if !p.IsSetReq() {
...
type CreateProductResult struct {
	Success *product.CreateResp
}

var CreateProductResult_Success_DEFAULT *product.CreateResp

func (p *CreateProductResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(product.CreateResp)
	}
	return p.Success.FastRead(buf, _type, number)
}
...
func (p *CreateProductResult) GetSuccess() *product.CreateResp {
	if !p.IsSetSuccess() {
...
func (p *CreateProductResult) SetSuccess(x interface{}) {
	p.Success = x.(*product.CreateResp)
}
...
var DeleteProductArgs_Req_DEFAULT *product.DeleteReq

func (p *DeleteProductArgs) GetReq() *product.DeleteReq {
	if !p.IsSetReq() {
...
type DeleteProductResult struct {
	Success *product.DeleteResp
}

var DeleteProductResult_Success_DEFAULT *product.DeleteResp

func (p *DeleteProductResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(product.DeleteResp)
	}
	return p.Success.FastRead(buf, _type, number)
}
...
func (p *DeleteProductResult) GetSuccess() *product.DeleteResp {
	if !p.IsSetSuccess() {
...
func (p *DeleteProductResult) SetSuccess(x interface{}) {
	p.Success = x.(*product.DeleteResp)
}
...
func (p *kClient) CreateProduct(ctx context.Context, Req *product.CreateReq) (r *product.CreateResp, err error) {
...
func (p *kClient) DeleteProduct(ctx context.Context, Req *product.DeleteReq) (r *product.DeleteResp, err error) {
