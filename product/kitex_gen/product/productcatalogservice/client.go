...
type Client interface {
	...
	CreateProduct(ctx context.Context, Req *product.CreateReq, callOptions ...callopt.Option) (r *product.CreateResp, err error)
	DeleteProduct(ctx context.Context, Req *product.DeleteReq, callOptions ...callopt.Option) (r *product.DeleteResp, err error)
}
...
func (p *kProductCatalogServiceClient) CreateProduct(ctx context.Context, Req *product.CreateReq, callOptions ...callopt.Option) (r *product.CreateResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.CreateProduct(ctx, Req)
}

func (p *kProductCatalogServiceClient) DeleteProduct(ctx context.Context, Req *product.DeleteReq, callOptions ...callopt.Option) (r *product.DeleteResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
