...
import (
	"context"
	"errors"
	auth "github.com/Camelia-hu/gomall/auth/kitex_gen/auth"
...
var ReFreshTokenByRPCArgs_Req_DEFAULT *auth.RefreshReq

func (p *ReFreshTokenByRPCArgs) GetReq() *auth.RefreshReq {
	if !p.IsSetReq() {
...
func (p *kClient) ReFreshTokenByRPC(ctx context.Context, Req *auth.RefreshReq) (r *auth.RefreshResp, err error) {
