...
type Client interface {
	...
	ReFreshTokenByRPC(ctx context.Context, Req *auth.RefreshReq, callOptions ...callopt.Option) (r *auth.RefreshResp, err error)
}
...
func (p *kAuthServiceClient) ReFreshTokenByRPC(ctx context.Context, Req *auth.RefreshReq, callOptions ...callopt.Option) (r *auth.RefreshResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
